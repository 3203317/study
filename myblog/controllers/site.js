...
exports.index = function(req, res, next) {
	var proxy = EventProxy.create('articles', 'top10ViewNums', 'top10Comments', 'usefulLinks', 'topMarks', function(articles, top10ViewNums, top10Comments, usefulLinks, topMarks){
		res.render('Index', { 
			moduleName: 'index',
			title: title,
			description: '个人博客',
